...
'''
Need to implement back propagation for the network with a hidden layer and a final fully connected layer. 
...
def compute_derivative_wrt_weights(weights):
    ...
    # loss = mean_squared_loss(actual_y, relu_activation(network_input(inpt_array, weights)))
    # loss_distrbd = mean_squared_loss(actual_y, relu_activation(network_input(inpt_array, weights_distrbd)))
